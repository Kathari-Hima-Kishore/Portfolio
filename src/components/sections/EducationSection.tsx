        ...
        <section id="phase-6" className={`min-h-screen flex items-center justify-center ${isMobile ? 'p-4' : 'p-8'}`}>
            ...
            >
                ...
                <div className="brutal-card p-6 rounded-xl">
                    ...
                    <div className={`brutal-card rounded-2xl text-left relative overflow-hidden ${isMobile ? 'p-6' : 'p-8'}`}>
                        <div className={`absolute top-0 right-0 opacity-20 brutal-text-yellow leading-none select-none ${isMobile ? 'p-2 text-7xl' : 'p-4 text-9xl'}`}>26</div>
                        ...
                        <div className="flex justify-between items-end brutal-border pt-6 mt-6">
                            <div>
                                <span className="block text-xs uppercase tracking-widest brutal-text-cyan mb-1">Duration</span>
                                <span className="text-white">Aug 2022 – Jul 2026</span>
                            </div>
                            <div className="text-right">
                                <span className="block text-xs uppercase tracking-widest brutal-text-pink mb-1">Grade</span>
                                <span className="text-3xl font-bold brutal-text-lime">8.9 <span className="text-sm font-normal text-white/40">CGPA</span></span>
                            </div>
                        </div>
                    </div>
                </div>
